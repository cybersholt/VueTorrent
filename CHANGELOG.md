...
## [3.0.0](https://github.com/cybersholt/VueTorrent/compare/v2.5.0...v3.0.0) (2024-01-20)


### ⚠ BREAKING CHANGES

* Vue3 Rewrite ([#757](https://github.com/cybersholt/VueTorrent/issues/757))

### Features

* Add import / export settings button ([#659](https://github.com/cybersholt/VueTorrent/issues/659)) @Larsluph ([7caa19a](https://github.com/cybersholt/VueTorrent/commit/7caa19ab889464d00d58630f93a84e98fbb82eca))
* add logs view ([#904](https://github.com/cybersholt/VueTorrent/issues/904)) ([0c6e9d8](https://github.com/cybersholt/VueTorrent/commit/0c6e9d86d599679eb5f352fed7a5a51190cfb927))
* Add settings to Show/Hide fields in mobile torrent card ([#687](https://github.com/cybersholt/VueTorrent/issues/687)) @Larsluph ([88bc931](https://github.com/cybersholt/VueTorrent/commit/88bc9317c9864145712b897905cce7cab073066c))
* Add shutdown button in TopActions ([#633](https://github.com/cybersholt/VueTorrent/issues/633)) @Larsluph ([ab75f32](https://github.com/cybersholt/VueTorrent/commit/ab75f32c5f6225fb9b2615f2880b2ef40037820a))
* Add TorrentDetail overview tab ([#917](https://github.com/cybersholt/VueTorrent/issues/917)) ([4e67040](https://github.com/cybersholt/VueTorrent/commit/4e6704081dd8210f9de2559f6755f789bfa09034))
* Add tracker host in Dashboard ([#679](https://github.com/cybersholt/VueTorrent/issues/679)) [@flashlab](https://github.com/flashlab) ([bf9484b](https://github.com/cybersholt/VueTorrent/commit/bf9484b1426ad8de166b725745b409c898cc56e5))
* **AddTorrentDialog:** Rework dialog to add missing parameters ([#1323](https://github.com/cybersholt/VueTorrent/issues/1323)) ([f69851c](https://github.com/cybersholt/VueTorrent/commit/f69851cc39bd7ca47f426a5eb5d900c5c428b758))
* **Chips:** Add option to hide values if empty ([#1380](https://github.com/cybersholt/VueTorrent/issues/1380)) ([6b94f6e](https://github.com/cybersholt/VueTorrent/commit/6b94f6e2c28d8f8271a3059e5a5d3b75ed360379))
* **ConnectionStatusDialog:** Add DHT node and active peer connections ([#1312](https://github.com/cybersholt/VueTorrent/issues/1312)) ([6f01c00](https://github.com/cybersholt/VueTorrent/commit/6f01c008e88ad3c4a45fab7f8624416975756033))
* **Content:** Add menu to set file priority ([#1333](https://github.com/cybersholt/VueTorrent/issues/1333)) ([f83fe06](https://github.com/cybersholt/VueTorrent/commit/f83fe0691a939a99ed4490d22d8aba9c1994d67d))
* **dashboard:** Add display mode configuration ([#1184](https://github.com/cybersholt/VueTorrent/issues/1184)) ([cd695ab](https://github.com/cybersholt/VueTorrent/commit/cd695ab96da160493f0e7c790e117a056989e4c8))
* **dashboard:** Add DL / UL Speed average to DashboardItems ([#1203](https://github.com/cybersholt/VueTorrent/issues/1203)) ([7af47f9](https://github.com/cybersholt/VueTorrent/commit/7af47f9e3d375be39fe133f10c69eeee5fa3ff43))
* **filters:** Allow multiple selection ([#1202](https://github.com/cybersholt/VueTorrent/issues/1202)) ([41318c3](https://github.com/cybersholt/VueTorrent/commit/41318c3d85da44833b7ce1e2afba9a613b07c624))
* **filters:** Allow to disable filters temporarily ([6f9ee5d](https://github.com/cybersholt/VueTorrent/commit/6f9ee5d0e36bd0a9e1707f50edc84d8979ae7a51))
* **history:** Add history to some fields ([#1361](https://github.com/cybersholt/VueTorrent/issues/1361)) ([ef50c6c](https://github.com/cybersholt/VueTorrent/commit/ef50c6c3411ce4745ed79eae3c156250fe68a7f4))
* **localization:** Bringing back Russian locale ([#1281](https://github.com/cybersholt/VueTorrent/issues/1281)) ([20dc684](https://github.com/cybersholt/VueTorrent/commit/20dc6843aa587dd571362efa34cd6cc986af4591))
* login with url query ([#1108](https://github.com/cybersholt/VueTorrent/issues/1108)) ([459b7e0](https://github.com/cybersholt/VueTorrent/commit/459b7e08f2c630f6e92a459fd39b3dade7ef7fdf))
* **Overview:** Add keyboard shortcuts ([#1335](https://github.com/cybersholt/VueTorrent/issues/1335)) ([15a20a3](https://github.com/cybersholt/VueTorrent/commit/15a20a3a4e68d86ddf54c0ee13463ed2288ddfc9))
* **preferences:** Update settings page to include missing preferences ([#1296](https://github.com/cybersholt/VueTorrent/issues/1296)) ([e034071](https://github.com/cybersholt/VueTorrent/commit/e0340710cc7dce842d260edaf0848e241a36208b))
* **RSS:** Add conf to use ID instead of link ([#1334](https://github.com/cybersholt/VueTorrent/issues/1334)) ([6af7537](https://github.com/cybersholt/VueTorrent/commit/6af75375571fadd650d1342c132e34d3ec6c3f49))
* **RSS:** Allow edit feed URL (4.6.0+) ([#1433](https://github.com/cybersholt/VueTorrent/issues/1433)) ([ade6def](https://github.com/cybersholt/VueTorrent/commit/ade6defb826f3868532ac4d16ad0bdb2eec5a556))
* **Settings:** Handle tab routes in settings ([#1355](https://github.com/cybersholt/VueTorrent/issues/1355)) ([fdad814](https://github.com/cybersholt/VueTorrent/commit/fdad814b1fabf9b3f141f5685fc9291434866e26))
* **ShareLimit:** Add torrent share limit dialog ([ed0991e](https://github.com/cybersholt/VueTorrent/commit/ed0991e0a5b3985dbea40d343dc6a3c8224e1f32))
* **title:** Ability to set custom browser tab title ([1f58005](https://github.com/cybersholt/VueTorrent/commit/1f58005109ab5b8a1cf6d9575246e24a105cc3a8))
* **transfer limit:** Add callbacks for download / upload torrent limit ([#1217](https://github.com/cybersholt/VueTorrent/issues/1217)) ([1792df9](https://github.com/cybersholt/VueTorrent/commit/1792df965ba78c83264b315b6f1ecbaca4b08e04))
* **units:** customizable units ([#984](https://github.com/cybersholt/VueTorrent/issues/984)) ([0594af3](https://github.com/cybersholt/VueTorrent/commit/0594af387f9679610fd1bc887db3915ce345c65b))
* Vue3 Rewrite ([#757](https://github.com/cybersholt/VueTorrent/issues/757)) ([575b071](https://github.com/cybersholt/VueTorrent/commit/575b071f6db9edc01412fab45109d3f4d203552d))


### Bug Fixes

* 400 when adding trackers ([#674](https://github.com/cybersholt/VueTorrent/issues/674)) @Larsluph ([9d31ff4](https://github.com/cybersholt/VueTorrent/commit/9d31ff4360997b03273751b7aa45c143b6ac0cf8))
* **accessibility:** Add name attributes to login form ([#1467](https://github.com/cybersholt/VueTorrent/issues/1467)) ([bf9566f](https://github.com/cybersholt/VueTorrent/commit/bf9566fbbf36cbf18a69a8c2bf8cb289564394e8))
* Add custom key to prevent duplicate keys ([#814](https://github.com/cybersholt/VueTorrent/issues/814)) ([b63a7e0](https://github.com/cybersholt/VueTorrent/commit/b63a7e039d3b39a61dd6a647ad45b015490cba40))
* AddModal button not present on desktop ([#935](https://github.com/cybersholt/VueTorrent/issues/935)) ([8a2e2bf](https://github.com/cybersholt/VueTorrent/commit/8a2e2bf8a215d66b8cc5a17375e6a7372bd3b675))
* **AddTorrentDialog:** Add autocomplete attribute ([#1331](https://github.com/cybersholt/VueTorrent/issues/1331)) ([aaa4cc1](https://github.com/cybersholt/VueTorrent/commit/aaa4cc16e9e7cac207a8286ce950e924c7718327))
* **AddTorrentDialog:** Dialog was never initialized with default values ([#1214](https://github.com/cybersholt/VueTorrent/issues/1214)) ([44fd8d3](https://github.com/cybersholt/VueTorrent/commit/44fd8d38619b7a468f8f0a7e04c71cf9cd94683b))
* **AddTorrentDialog:** Fix falsy values not sent to qbit ([#1377](https://github.com/cybersholt/VueTorrent/issues/1377)) ([8abda97](https://github.com/cybersholt/VueTorrent/commit/8abda97341d3446890ad41f5d45618b87c6ad03f))
* **AddTorrentDialog:** Fix persistence not working ([#1213](https://github.com/cybersholt/VueTorrent/issues/1213)) ([9ee6533](https://github.com/cybersholt/VueTorrent/commit/9ee65335e129139a4cff4ba307d94b8075f66558))
* **AddTorrentDialog:** Prevent undefined values from being sent through API ([#1330](https://github.com/cybersholt/VueTorrent/issues/1330)) ([6575ade](https://github.com/cybersholt/VueTorrent/commit/6575ade19e0bb6443bc8e29187cf952ff4f67262))
* **AddTorrent:** Error while accessing preferences ([#1216](https://github.com/cybersholt/VueTorrent/issues/1216)) ([c760072](https://github.com/cybersholt/VueTorrent/commit/c76007241dbd604f6e31bc506b88a065dc57d920))
* **Advanced:** Network interfaces doesn't fill properly ([#1337](https://github.com/cybersholt/VueTorrent/issues/1337)) ([3c44709](https://github.com/cybersholt/VueTorrent/commit/3c447098c63c2fd758947067f3a3c2b3ea763078))
* App not redirecting to login page ([#1008](https://github.com/cybersholt/VueTorrent/issues/1008)) ([cd1e77b](https://github.com/cybersholt/VueTorrent/commit/cd1e77b0c22d7905ee34478187205f252856e4b9))
* authentication race condition ([#1319](https://github.com/cybersholt/VueTorrent/issues/1319)) ([153268f](https://github.com/cybersholt/VueTorrent/commit/153268f30d3f2f8c618083caebd51894a42bc32a))
* bugs introduced with search engine ([#853](https://github.com/cybersholt/VueTorrent/issues/853)) ([ff301f2](https://github.com/cybersholt/VueTorrent/commit/ff301f249ca76d7fb0f26d3a26f78ddeaf43df17))
* cache app.js in PWA mode ([#1038](https://github.com/cybersholt/VueTorrent/issues/1038)) ([9ea02fb](https://github.com/cybersholt/VueTorrent/commit/9ea02fbf8c786363eb273d40d333eb50f34ce6e3))
* capitalization [#740](https://github.com/cybersholt/VueTorrent/issues/740) ([54b4f57](https://github.com/cybersholt/VueTorrent/commit/54b4f578d1b3c0491d16024e6d377090d520cac5))
* change rss-unread color from white to #ccc ([#643](https://github.com/cybersholt/VueTorrent/issues/643)) [@hqwuzhaoyi](https://github.com/hqwuzhaoyi) ([dd02cdb](https://github.com/cybersholt/VueTorrent/commit/dd02cdb564803495af0ea60a61c65562b3fe8ea5))
* change settings speed tab speed unit to KiBps ([#1082](https://github.com/cybersholt/VueTorrent/issues/1082)) ([587038a](https://github.com/cybersholt/VueTorrent/commit/587038a7ae25fcedcb29b358a12e5f3a3b38ce64))
* chart flickering ([#644](https://github.com/cybersholt/VueTorrent/issues/644)) @Hans1208 ([5e3d6b7](https://github.com/cybersholt/VueTorrent/commit/5e3d6b778892fc6b157ba533f288e77ceed091c7))
* Chinese translations([#1189](https://github.com/cybersholt/VueTorrent/issues/1189)) ([3f34cfc](https://github.com/cybersholt/VueTorrent/commit/3f34cfcfdb9b9ff0a0c1030e2cb82fd671c562a0))
* Chinese word order problem ([#765](https://github.com/cybersholt/VueTorrent/issues/765)) ([f1bb9b7](https://github.com/cybersholt/VueTorrent/commit/f1bb9b7b354ab2ba47f5d0180dfe3d4a8f824e43))
* **clipboard:** Add missing toast on clipboard action ([#1452](https://github.com/cybersholt/VueTorrent/issues/1452)) ([9b81865](https://github.com/cybersholt/VueTorrent/commit/9b81865ded1fcc57c105376418a1e76871b6626b))
* cmd select torrent ([#702](https://github.com/cybersholt/VueTorrent/issues/702)) ([97f7705](https://github.com/cybersholt/VueTorrent/commit/97f77050f0b9926fd2c40da0fd2e6d8c5e930fe9))
* **Content:** Fix percent progress not displaying properly ([#1007](https://github.com/cybersholt/VueTorrent/issues/1007)) ([ef546cb](https://github.com/cybersholt/VueTorrent/commit/ef546cb96cc0ce255883bd9c2b2645c3abb48784))
* context-menu not appearing ([#848](https://github.com/cybersholt/VueTorrent/issues/848)) ([6810ec7](https://github.com/cybersholt/VueTorrent/commit/6810ec7cb4234088004709b4ae3c97c0d5d6a989))
* Ctrl key not being handled on Windows ([#715](https://github.com/cybersholt/VueTorrent/issues/715)) ([ba77afb](https://github.com/cybersholt/VueTorrent/commit/ba77afb35dcddc658de778da61b233ed113e9e0c))
* dark theme color [#662](https://github.com/cybersholt/VueTorrent/issues/662) ([2921cca](https://github.com/cybersholt/VueTorrent/commit/2921cca79cb50280c4f6fbc84dc4aebb48aa0c39))
* **dashboard:** Fix span selection not using filters ([#1311](https://github.com/cybersholt/VueTorrent/issues/1311)) ([06d1815](https://github.com/cybersholt/VueTorrent/commit/06d1815f002b01843518a6bbf54b976c35be1054))
* **dashboard:** Not able to delete torrent in certain cases ([#975](https://github.com/cybersholt/VueTorrent/issues/975)) ([4445d37](https://github.com/cybersholt/VueTorrent/commit/4445d371390463d4a801dc6fa1edc04bf76b7847))
* **dashboard:** Sort not working anymore ([#1211](https://github.com/cybersholt/VueTorrent/issues/1211)) ([b2bbcb9](https://github.com/cybersholt/VueTorrent/commit/b2bbcb987e7569bfb58bf01930f4d6cbcb9e95c3))
* **dashboard:** Take filters into account when selecting all torrents ([9f4aa4a](https://github.com/cybersholt/VueTorrent/commit/9f4aa4a119046d72eb5c2ad0047205c32c426c7a))
* delayed torrent display on page opening ([#1022](https://github.com/cybersholt/VueTorrent/issues/1022)) ([ee6a73e](https://github.com/cybersholt/VueTorrent/commit/ee6a73eacc1b7c922917a21bae6f966fa4b74c25))
* disable progress bar striping [#1324](https://github.com/cybersholt/VueTorrent/issues/1324) ([5e06f6d](https://github.com/cybersholt/VueTorrent/commit/5e06f6d1f2018f74307d8a7dc09ed485c1cca179))
* Drag-and-Drop not working ([#669](https://github.com/cybersholt/VueTorrent/issues/669)) @Larsluph ([141318a](https://github.com/cybersholt/VueTorrent/commit/141318affc5e26e98abcd8d292e75e0636b7a3db))
* Duplicate intervals ([#689](https://github.com/cybersholt/VueTorrent/issues/689)) @Larsluph ([a822702](https://github.com/cybersholt/VueTorrent/commit/a822702e69ad1c2b2ff9f58d82b07dd89e8ec605))
* **duration:** Values greater than a month weren't displayed ([#1381](https://github.com/cybersholt/VueTorrent/issues/1381)) ([8ba6d12](https://github.com/cybersholt/VueTorrent/commit/8ba6d120c699f68806e9735068c9a917de386323))
* error from context menu when deleting torrent ([2dcf9d2](https://github.com/cybersholt/VueTorrent/commit/2dcf9d268cc12a3705955c51aaccdc67193a22d0))
* events not working properly on views ([#912](https://github.com/cybersholt/VueTorrent/issues/912)) ([906da74](https://github.com/cybersholt/VueTorrent/commit/906da74ee4a167e8fcd8d908d3f84fbfffcdbca3))
* explicitly match the file ([#1065](https://github.com/cybersholt/VueTorrent/issues/1065)) ([7ea8ac3](https://github.com/cybersholt/VueTorrent/commit/7ea8ac3ded7e523239c5c230f8a36b93095cc7f7))
* favicons ([#898](https://github.com/cybersholt/VueTorrent/issues/898)) ([942b1a9](https://github.com/cybersholt/VueTorrent/commit/942b1a9f65798dab602ce40f945c81ee53db8ce2))
* Fix JSON validation not working ([#682](https://github.com/cybersholt/VueTorrent/issues/682)) ([2784ab9](https://github.com/cybersholt/VueTorrent/commit/2784ab97cf67f019ab259471eda2b957ed81f6a2))
* Forced state not present in MobileCard ([#632](https://github.com/cybersholt/VueTorrent/issues/632)) @Larsluph ([7114ce1](https://github.com/cybersholt/VueTorrent/commit/7114ce12df6bf7a0992406245277093c52d16002))
* formatDataValues for values with 4 digits or more ([#1083](https://github.com/cybersholt/VueTorrent/issues/1083)) ([ad562f0](https://github.com/cybersholt/VueTorrent/commit/ad562f056a4976b484ae7f98da2eef8153f9b0c4))
* Handle Windows path separators ([#675](https://github.com/cybersholt/VueTorrent/issues/675)) @Larsluph ([f4646e2](https://github.com/cybersholt/VueTorrent/commit/f4646e2e669191e51f06f1abeb0d37bf1aa7663c))
* **helpers:** Rework toPrecision ([#1394](https://github.com/cybersholt/VueTorrent/issues/1394)) ([69398e0](https://github.com/cybersholt/VueTorrent/commit/69398e02a5efdeb226486839a5259ea9dbba2fef))
* hungarian translations ([#1127](https://github.com/cybersholt/VueTorrent/issues/1127)) ([2c9c9d5](https://github.com/cybersholt/VueTorrent/commit/2c9c9d5ac197c1e56fec2f26c20fc631c2dc86e1))
* incorrect enum values for MaxRatioAction ([#673](https://github.com/cybersholt/VueTorrent/issues/673)) @Larsluph ([afa9f0e](https://github.com/cybersholt/VueTorrent/commit/afa9f0ef3065702c0d55f1a7ca5a78066610264c))
* invalid v-model for auto add trackers ([#820](https://github.com/cybersholt/VueTorrent/issues/820)) ([9d4b30c](https://github.com/cybersholt/VueTorrent/commit/9d4b30c5647571757786db5d334d1089084af854))
* light theme handling ([#937](https://github.com/cybersholt/VueTorrent/issues/937)) ([3d3b1bf](https://github.com/cybersholt/VueTorrent/commit/3d3b1bf4d847bf2c7ffc86e6fe6fcc3a286261e2))
* locale key for [#967](https://github.com/cybersholt/VueTorrent/issues/967) ([#973](https://github.com/cybersholt/VueTorrent/issues/973)) ([6b2a444](https://github.com/cybersholt/VueTorrent/commit/6b2a44495c26600e016732a71e8bc634d8e6414d))
* logout behaviour ([8533344](https://github.com/cybersholt/VueTorrent/commit/8533344d888bb02e8e5ecaf2182b18351ea9ae70))
* **logs:** wrong date parsing ([#1076](https://github.com/cybersholt/VueTorrent/issues/1076)) ([14a6b90](https://github.com/cybersholt/VueTorrent/commit/14a6b90547dda3284254608f6cd203bc84634768))
* magnet handling ([#1041](https://github.com/cybersholt/VueTorrent/issues/1041)) ([c57da2d](https://github.com/cybersholt/VueTorrent/commit/c57da2d95a1100e43bdeb0d7f62512b88d27af10))
* magnet handling issue caused by [#1041](https://github.com/cybersholt/VueTorrent/issues/1041) ([#1056](https://github.com/cybersholt/VueTorrent/issues/1056)) ([6432dd9](https://github.com/cybersholt/VueTorrent/commit/6432dd94168e37b8af2cd66241234cdec8c7738d))
* make info tab selectable [#1413](https://github.com/cybersholt/VueTorrent/issues/1413) ([7e8cc9c](https://github.com/cybersholt/VueTorrent/commit/7e8cc9cdbcaa741c2c91c79b8cb113587662174c))
* Missing state filters ([#718](https://github.com/cybersholt/VueTorrent/issues/718)) ([74cfeca](https://github.com/cybersholt/VueTorrent/commit/74cfecace0a46abc4fbe843b15131ce85e8fbb79))
* mobile long press [#911](https://github.com/cybersholt/VueTorrent/issues/911) ([6871e54](https://github.com/cybersholt/VueTorrent/commit/6871e54f94c19f4c5d54f6d5056a4f1b302a956a))
* mobile long press [#911](https://github.com/cybersholt/VueTorrent/issues/911) ([d394ab8](https://github.com/cybersholt/VueTorrent/commit/d394ab885b6fec200f5878993c6918c906cc6f2f))
* mobile page search layout [#635](https://github.com/cybersholt/VueTorrent/issues/635) ([d1def31](https://github.com/cybersholt/VueTorrent/commit/d1def31d055cb51a01bfeae12b1385dbca0b7e71))
* mobile plus button not working ([#945](https://github.com/cybersholt/VueTorrent/issues/945)) ([d1fda81](https://github.com/cybersholt/VueTorrent/commit/d1fda8155d79ed6be7417f4984911370fa96b595))
* navbar capitalisation ([#835](https://github.com/cybersholt/VueTorrent/issues/835)) ([8ad5b94](https://github.com/cybersholt/VueTorrent/commit/8ad5b9425e0eca17cc73a04ab0fe4f218b42be7e))
* **Navbar:** Add missing bind on right drawer setting ([#1294](https://github.com/cybersholt/VueTorrent/issues/1294)) ([672ab08](https://github.com/cybersholt/VueTorrent/commit/672ab0863f3ee41a5fb2fd17bdba81306fb91be3))
* **overview:** Canvas not displaying correctly ([#1032](https://github.com/cybersholt/VueTorrent/issues/1032)) ([b68c487](https://github.com/cybersholt/VueTorrent/commit/b68c4870ef47001989735166440bfc2b3eca103a))
* peers not showing up ([#660](https://github.com/cybersholt/VueTorrent/issues/660)) ([d8ca97d](https://github.com/cybersholt/VueTorrent/commit/d8ca97d92821eaf455079a4248d7af95d643fe34))
* phone check shutdown modal ([ff9f159](https://github.com/cybersholt/VueTorrent/commit/ff9f1594cdebb73aa2daf97f83e6520d77dbcd4b))
* prevent mark all to send useless requests between single mark ([#799](https://github.com/cybersholt/VueTorrent/issues/799)) ([2fdeb63](https://github.com/cybersholt/VueTorrent/commit/2fdeb63c83eee6bbcdcc0bc639a4d3d303f10e20))
* progress and relavance numbers in DetailedPeers screen ([#1034](https://github.com/cybersholt/VueTorrent/issues/1034)) ([4cd7772](https://github.com/cybersholt/VueTorrent/commit/4cd7772502f0dacf595aeb6d70e52bb458156330))
* redirect to login when auth expires [#607](https://github.com/cybersholt/VueTorrent/issues/607) ([0cc22ae](https://github.com/cybersholt/VueTorrent/commit/0cc22ae1ea14649e4ca01620671f87181d10469f))
* reduce title size [#1288](https://github.com/cybersholt/VueTorrent/issues/1288) ([aab5cc1](https://github.com/cybersholt/VueTorrent/commit/aab5cc16edd7247196daf298a366e0d369cfb932))
* reduce title size [#1288](https://github.com/cybersholt/VueTorrent/issues/1288) ([0c7701a](https://github.com/cybersholt/VueTorrent/commit/0c7701a4d2cd46b7851760e46dc7cf85ef0b6f5a))
* Remove capitalization ([#807](https://github.com/cybersholt/VueTorrent/issues/807)) ([856b3d7](https://github.com/cybersholt/VueTorrent/commit/856b3d7b5ce4f750f7961e88f27789a6bba8d3e5))
* Remove savePath rule when creating category ([#970](https://github.com/cybersholt/VueTorrent/issues/970)) ([9f59632](https://github.com/cybersholt/VueTorrent/commit/9f59632d912acc58f022f9aacfd288d0cd66effc))
* Remove unneeded classes to prevent unexpected color background in MobileCard ([#782](https://github.com/cybersholt/VueTorrent/issues/782)) ([6745c91](https://github.com/cybersholt/VueTorrent/commit/6745c91a3ca20476bdc97127d506d182bb899560))
* Repair broken keybinds ([#942](https://github.com/cybersholt/VueTorrent/issues/942)) ([5a861de](https://github.com/cybersholt/VueTorrent/commit/5a861deeb25eeda086ac3e07bc31815c67a0f165))
* Replace root_folder param with contentLayout & stopCondition ([#665](https://github.com/cybersholt/VueTorrent/issues/665)) @Larsluph ([f0ddc60](https://github.com/cybersholt/VueTorrent/commit/f0ddc603bdab2c5ee155e2289d573818407cf4d9))
* Revert "fix(logs): Wrong date parsing" ([#1099](https://github.com/cybersholt/VueTorrent/issues/1099)) ([1110bdb](https://github.com/cybersholt/VueTorrent/commit/1110bdb8b780d9512366d1e46ed8aecadb2efa4d))
* revert longpress fix, unreliable on pwa [#911](https://github.com/cybersholt/VueTorrent/issues/911) ([3214997](https://github.com/cybersholt/VueTorrent/commit/3214997194f76d01b3ead9439589c3103eb2728c))
* revert old proxy types ([#832](https://github.com/cybersholt/VueTorrent/issues/832)) ([f3694e9](https://github.com/cybersholt/VueTorrent/commit/f3694e990aa6e90fcc0654ac66e00a10fb006ea9))
* **RightClickMenu:** Fix target not being selected on long press ([#1295](https://github.com/cybersholt/VueTorrent/issues/1295)) ([d80cc35](https://github.com/cybersholt/VueTorrent/commit/d80cc35e94f3caa94520abf5ed83ba29b7d3bc2c))
* **rss:** Update overflow rules to handle long name without spaces ([#1228](https://github.com/cybersholt/VueTorrent/issues/1228)) ([e2ce2e8](https://github.com/cybersholt/VueTorrent/commit/e2ce2e86f5ff59499834a91b8de6c3bc8aa1e156))
* scrollbar styling [#1397](https://github.com/cybersholt/VueTorrent/issues/1397) ([7fb4107](https://github.com/cybersholt/VueTorrent/commit/7fb410732a21dbacac6c82e7f96fec2b92d03726))
* searchFilter is sometimes null ([#918](https://github.com/cybersholt/VueTorrent/issues/918)) ([f5adce6](https://github.com/cybersholt/VueTorrent/commit/f5adce657de72b421d22d6ae19e53daa6b7ed909))
* **search:** remove limit parameter ([#946](https://github.com/cybersholt/VueTorrent/issues/946)) ([7b77162](https://github.com/cybersholt/VueTorrent/commit/7b77162871bc1eae202ac6a13a5236471d344928))
* select label color is white (regardless of the selected theme) ([#812](https://github.com/cybersholt/VueTorrent/issues/812)) ([ef333b2](https://github.com/cybersholt/VueTorrent/commit/ef333b23668916430b864f620ab849b6511cd7d2))
* **Settings/Speed:** Fix speed values conversion ([#1332](https://github.com/cybersholt/VueTorrent/issues/1332)) ([02c0496](https://github.com/cybersholt/VueTorrent/commit/02c049692bb6fc88f1ca76faa1b271118eb7eb4a))
* **settings:** Add DnD exception on settings page ([d91070b](https://github.com/cybersholt/VueTorrent/commit/d91070b4a28508d1ea7c4ad7e6e595f358194657))
* **settings:** Update disabled state in Bittorrent tab ([#1301](https://github.com/cybersholt/VueTorrent/issues/1301)) ([f1cefe4](https://github.com/cybersholt/VueTorrent/commit/f1cefe4e3ced36b81feab03e7e5fdf852b7b131e))
* **settings:** Update drag handling to completed properties ([#1286](https://github.com/cybersholt/VueTorrent/issues/1286)) ([dd53e6f](https://github.com/cybersholt/VueTorrent/commit/dd53e6fc9d299b506b8c3f28c19ee131aa811430))
* size error ([#900](https://github.com/cybersholt/VueTorrent/issues/900)) ([d1d5498](https://github.com/cybersholt/VueTorrent/commit/d1d5498e31c6d672ba5a413784aad7c50f152c43))
* size error when deleting torrents under certain conditions ([#862](https://github.com/cybersholt/VueTorrent/issues/862)) ([fe1f962](https://github.com/cybersholt/VueTorrent/commit/fe1f962c3308ed398f652ccea60a1e864b20827a))
* size error when deleting torrents under certain conditions ([#870](https://github.com/cybersholt/VueTorrent/issues/870)) ([09828cb](https://github.com/cybersholt/VueTorrent/commit/09828cb9ab33c12c4d3176695a0a6ddedae35e4b))
* **sortBy:** Fix height overflow ([#1441](https://github.com/cybersholt/VueTorrent/issues/1441)) ([b261d15](https://github.com/cybersholt/VueTorrent/commit/b261d1547a966155740e47227d6e29c316e9136a))
* state glitching [#724](https://github.com/cybersholt/VueTorrent/issues/724) ([260c1c6](https://github.com/cybersholt/VueTorrent/commit/260c1c6960dcd7e505e8643db9f362b0acc3cbc7))
* sticky add button [#1415](https://github.com/cybersholt/VueTorrent/issues/1415) ([64c595e](https://github.com/cybersholt/VueTorrent/commit/64c595eeac6e48d86c11ddc533122f1658c1b6a8))
* **styles:** overflowing tab arrows with light theme [#1040](https://github.com/cybersholt/VueTorrent/issues/1040) ([a91712a](https://github.com/cybersholt/VueTorrent/commit/a91712a5da7db9951bd93e19ff0459c5e1c78934))
* **tabs:** Remove swipe gestures ([#1356](https://github.com/cybersholt/VueTorrent/issues/1356)) ([41e021c](https://github.com/cybersholt/VueTorrent/commit/41e021c63c67e87146f354f6c5aecbb6906486ee))
* **tags:** Fix tags being duplicated ([#959](https://github.com/cybersholt/VueTorrent/issues/959)) ([2cca039](https://github.com/cybersholt/VueTorrent/commit/2cca039e1860d0eb7dc2fdb483243f61c5ccabfa))
* **TorrentCard:** Fix properties not being persisted ([#1252](https://github.com/cybersholt/VueTorrent/issues/1252)) ([c61b957](https://github.com/cybersholt/VueTorrent/commit/c61b957683c5ee6591b27de755fdad062e93e16f))
* **torrent:** Wrong date format on longer duration than month ([091244b](https://github.com/cybersholt/VueTorrent/commit/091244b718081138beb6e71d27d10fe45ceadc27))
* Trackers view ([#700](https://github.com/cybersholt/VueTorrent/issues/700)) ([ee4cb7e](https://github.com/cybersholt/VueTorrent/commit/ee4cb7ec1f6de1f362962f1545e2d361c0baab46))
* translation of properties ([3e95230](https://github.com/cybersholt/VueTorrent/commit/3e95230ae822673d6340874518e7557e0e20bf52))
* transparent bg for speed dial ([#927](https://github.com/cybersholt/VueTorrent/issues/927)) ([5b1a1bc](https://github.com/cybersholt/VueTorrent/commit/5b1a1bc91758cb7998203e468283c40bdac6f0d4)), closes [#926](https://github.com/cybersholt/VueTorrent/issues/926)
* **TRC:** Use all selected torrents for transfer limits ([#1329](https://github.com/cybersholt/VueTorrent/issues/1329)) ([3614081](https://github.com/cybersholt/VueTorrent/commit/3614081f198e1bedd35a2fbf54aa18a366594cf6))
* Unwanted torrent selection during search ([#664](https://github.com/cybersholt/VueTorrent/issues/664)) @MBR-0001 ([a56aa63](https://github.com/cybersholt/VueTorrent/commit/a56aa63ab9988a689b9fb40a34e345d8e239bafa))
* use expansion panel for logs [#1420](https://github.com/cybersholt/VueTorrent/issues/1420) ([6979c49](https://github.com/cybersholt/VueTorrent/commit/6979c493ca65071633c4938a5f2bf8d5d236c9c2))
* WebUI Password may be sent as empty string ([#823](https://github.com/cybersholt/VueTorrent/issues/823)) ([abdaa0f](https://github.com/cybersholt/VueTorrent/commit/abdaa0fefb61587774eb189d1cb5c6f8af6d0806))


### Improvements

* Add 'Ctrl + F' shortcut to focus search filter ([#692](https://github.com/cybersholt/VueTorrent/issues/692)) @Larsluph ([cff2191](https://github.com/cybersholt/VueTorrent/commit/cff2191c760a18331bb89289062840bf44efa8c8))
* Add active filter ([#868](https://github.com/cybersholt/VueTorrent/issues/868)) ([e007289](https://github.com/cybersholt/VueTorrent/commit/e007289b4817dbbc2ea65961ab675a17a315e38d))
* Add autofocus on login page ([#1117](https://github.com/cybersholt/VueTorrent/issues/1117)) ([7ca220d](https://github.com/cybersholt/VueTorrent/commit/7ca220dfa6eff9a6f943fcacd045ef6b8f2ce570))
* add check latest version [#941](https://github.com/cybersholt/VueTorrent/issues/941) ([6eb2c15](https://github.com/cybersholt/VueTorrent/commit/6eb2c15e20f4706098664e674ffa20ee2ac98c21))
* add Chinese translations ([#1185](https://github.com/cybersholt/VueTorrent/issues/1185)) ([c50f1df](https://github.com/cybersholt/VueTorrent/commit/c50f1df4d6027588e6d8fc9465d0bfeafd934f83))
* Add download path management ([#1359](https://github.com/cybersholt/VueTorrent/issues/1359)) ([988ecaa](https://github.com/cybersholt/VueTorrent/commit/988ecaaa03116c2c4fa9a4cbb4ce4e284fa4c7c3))
* Add Escape / Enter keybinds to RSS modals ([#797](https://github.com/cybersholt/VueTorrent/issues/797)) ([b276004](https://github.com/cybersholt/VueTorrent/commit/b276004b2875391cf648247abbec026b71b598b5))
* Add hook to repaint piece state canvas on update ([#869](https://github.com/cybersholt/VueTorrent/issues/869)) ([87038f4](https://github.com/cybersholt/VueTorrent/commit/87038f48b9a4d8ace9f5234f9e36f62892c1f940))
* add Hungarian translations ([#1121](https://github.com/cybersholt/VueTorrent/issues/1121)) ([f584aad](https://github.com/cybersholt/VueTorrent/commit/f584aadcea38e28251f7347a8d794eca8ce807a0))
* Add mark all as read button in RssArticles view ([#798](https://github.com/cybersholt/VueTorrent/issues/798)) ([93d3fdc](https://github.com/cybersholt/VueTorrent/commit/93d3fdc85ae714ffe55a3fbf6c2330c2b6c4c89d))
* add mark as read behavior for rss articles ([#640](https://github.com/cybersholt/VueTorrent/issues/640)) @Larsluph ([3cfc82f](https://github.com/cybersholt/VueTorrent/commit/3cfc82f055bcc2a917e64e49c27137401d0a0810))
* Add missing fields in dashboard / sortOptions ([#713](https://github.com/cybersholt/VueTorrent/issues/713)) @Larsluph ([57b9aca](https://github.com/cybersholt/VueTorrent/commit/57b9acaeef407e16853103593a440a725b6f3964))
* Add missing torrent properties to TorrentDetail &gt; Info ([#744](https://github.com/cybersholt/VueTorrent/issues/744)) ([ecd8a4e](https://github.com/cybersholt/VueTorrent/commit/ecd8a4e608d687c80209ee6d5b6dad6a26bb943c))
* Add Monitored folders ([#802](https://github.com/cybersholt/VueTorrent/issues/802)) ([0deb6f8](https://github.com/cybersholt/VueTorrent/commit/0deb6f8e47e3fcd4b4d2a1b0cf0aa560ab219493))
* add multi-sort support ([#815](https://github.com/cybersholt/VueTorrent/issues/815)) ([a253f17](https://github.com/cybersholt/VueTorrent/commit/a253f17f2e81ff451a45ac4ac0fa75b61cdfdb03))
* Add progress bar toggle for mobile card ([#822](https://github.com/cybersholt/VueTorrent/issues/822)) ([2c43383](https://github.com/cybersholt/VueTorrent/commit/2c4338383b3f131fa7df231d2dd128ed158f4d42))
* Add qbit refresh interval setting ([#923](https://github.com/cybersholt/VueTorrent/issues/923)) ([d2cae69](https://github.com/cybersholt/VueTorrent/commit/d2cae697b83988da8d496c693b821c8af51c8ac3))
* Add Refresh All button for RSS feeds ([#775](https://github.com/cybersholt/VueTorrent/issues/775)) ([3e1d5fb](https://github.com/cybersholt/VueTorrent/commit/3e1d5fb76598ee7a432a56ea8b073a2bfe7dcba7))
* add refresh icon to RSS feeds ([#709](https://github.com/cybersholt/VueTorrent/issues/709)) ([a583b42](https://github.com/cybersholt/VueTorrent/commit/a583b42d68864c7280d6667706a7902b9b4e9fd1))
* Add right click exception on link elements ([#899](https://github.com/cybersholt/VueTorrent/issues/899)) ([b8324d9](https://github.com/cybersholt/VueTorrent/commit/b8324d96d8aae2d068fa775cddc4599a2aaa115a))
* Add RSS unread filter ([#657](https://github.com/cybersholt/VueTorrent/issues/657)) @Larsluph ([bc5695b](https://github.com/cybersholt/VueTorrent/commit/bc5695b8703704c5a540c515fa754f6b53428fcb))
* Add seeds sort options ([#711](https://github.com/cybersholt/VueTorrent/issues/711)) ([2c3afa5](https://github.com/cybersholt/VueTorrent/commit/2c3afa57994f651457b1aa29ee4205583eb72d44))
* Add sum of selected torrents' size to selectedTorrentCountString ([#803](https://github.com/cybersholt/VueTorrent/issues/803)) ([cf66103](https://github.com/cybersholt/VueTorrent/commit/cf66103aca48ae80822e92f573b26df19d54c0a0))
* Add switch to hide Shutdown button ([#685](https://github.com/cybersholt/VueTorrent/issues/685)) @Larsluph ([19e4eef](https://github.com/cybersholt/VueTorrent/commit/19e4eef0b893a0e78580e04bd204fe2afb6af1fd))
* Add text filter in active filter tooltip ([#915](https://github.com/cybersholt/VueTorrent/issues/915)) ([b0d7a25](https://github.com/cybersholt/VueTorrent/commit/b0d7a257525c8e348a762b0b28748ac50fa44333))
* add translations cron ([#1367](https://github.com/cybersholt/VueTorrent/issues/1367)) ([02d97f5](https://github.com/cybersholt/VueTorrent/commit/02d97f5283cf7f6d9f6a0fff42f07287c9c8f2dd))
* Add whenSeedingTimeReaches hint ([#826](https://github.com/cybersholt/VueTorrent/issues/826)) ([2e5ddcb](https://github.com/cybersholt/VueTorrent/commit/2e5ddcb319cb1c2d5d83098ea1c6b8e90e9b4ca9))
* **add-torrent:** Use scrollable dialog instead of manual infinite scroll ([#1442](https://github.com/cybersholt/VueTorrent/issues/1442)) ([7288861](https://github.com/cybersholt/VueTorrent/commit/7288861515ffb81d23ddcbce6446f0ad7726cab2))
* adding darker color to files actively or force uploading ([#1035](https://github.com/cybersholt/VueTorrent/issues/1035)) ([e2078e4](https://github.com/cybersholt/VueTorrent/commit/e2078e4444197e723aad6e052ca8a9e69266768b))
* **AddTorrentDialog:** Add loading prop to add button ([#1192](https://github.com/cybersholt/VueTorrent/issues/1192)) ([ac3bb69](https://github.com/cybersholt/VueTorrent/commit/ac3bb69a13e9b2bef3030f0b500ee37f1c79b0c5))
* **AddTorrentDialog:** persist form in sessionStorage ([#1193](https://github.com/cybersholt/VueTorrent/issues/1193)) ([e59f6bf](https://github.com/cybersholt/VueTorrent/commit/e59f6bf206e7ace0fbc5eead955ada5caa63bd4a))
* all-time ratio card ([#777](https://github.com/cybersholt/VueTorrent/issues/777)) ([f970564](https://github.com/cybersholt/VueTorrent/commit/f970564bf90aa82b553eb0e92911d3100b2e6150))
* Allow native find ([#864](https://github.com/cybersholt/VueTorrent/issues/864)) ([7221a3d](https://github.com/cybersholt/VueTorrent/commit/7221a3db4f7d465bcde5187174e52aa344d4692d))
* bring back active filter [#1280](https://github.com/cybersholt/VueTorrent/issues/1280) ([afe4fa5](https://github.com/cybersholt/VueTorrent/commit/afe4fa578456b807bf78a1f0f357fc995eca3168))
* bring back settings import [#1322](https://github.com/cybersholt/VueTorrent/issues/1322) ([53fe2e5](https://github.com/cybersholt/VueTorrent/commit/53fe2e55b64ea6cd1990b0a6c42a822203ff1258))
* cache fonts on PWA ([#1039](https://github.com/cybersholt/VueTorrent/issues/1039)) ([a16fb34](https://github.com/cybersholt/VueTorrent/commit/a16fb342b814a8b5e58d9b9316138b8bb0bab3c4))
* center login screen ([f773756](https://github.com/cybersholt/VueTorrent/commit/f773756b163f3dae13076bfa4008ba9f3c905ca9))
* change manual keyboard shortcuts to vue events ([#905](https://github.com/cybersholt/VueTorrent/issues/905)) ([e7171dc](https://github.com/cybersholt/VueTorrent/commit/e7171dca90d744211f43d610b6d7d5c97727e36f))
* complete RSS rule settings ([#731](https://github.com/cybersholt/VueTorrent/issues/731)) @Larsluph ([3690170](https://github.com/cybersholt/VueTorrent/commit/36901701c31ada48196b7258381fdf8725abda55))
* **dev:** Add MockProvider ([#1435](https://github.com/cybersholt/VueTorrent/issues/1435)) ([f5524b7](https://github.com/cybersholt/VueTorrent/commit/f5524b7d8b3c4e73369078636d8b67027f8f265b))
* **DnDZone:** Open add dialog on drop ([#1374](https://github.com/cybersholt/VueTorrent/issues/1374)) ([5635099](https://github.com/cybersholt/VueTorrent/commit/5635099eee2b14cfebb2a8f5775c59c02c3a61dc))
* enable manual sort for priority ([#845](https://github.com/cybersholt/VueTorrent/issues/845)) ([3bf470b](https://github.com/cybersholt/VueTorrent/commit/3bf470b890fae52a51e545cc3dec00796e040d9a))
* Extend RSS Feeds / Rules to use full width instead of half ([#811](https://github.com/cybersholt/VueTorrent/issues/811)) ([5056133](https://github.com/cybersholt/VueTorrent/commit/5056133c256013bd30355f027ca7984b4bbdf022))
* **faker:** Improve torrent mocking ([#1187](https://github.com/cybersholt/VueTorrent/issues/1187)) ([8b1f641](https://github.com/cybersholt/VueTorrent/commit/8b1f641fca79ad580bcb6d94f41ad0f52c495e80))
* **filters:** Reorder states ([197b9d7](https://github.com/cybersholt/VueTorrent/commit/197b9d7d029c6669cccfb4c4fc183d62fed45de6))
* Fixed intervals ([#1002](https://github.com/cybersholt/VueTorrent/issues/1002)) ([898040d](https://github.com/cybersholt/VueTorrent/commit/898040d5c926a49d6e168465347cd4c78c9c62c9))
* improve format when using timestamp 0 on SeenComplete ([#737](https://github.com/cybersholt/VueTorrent/issues/737)) ([3d5f6c8](https://github.com/cybersholt/VueTorrent/commit/3d5f6c86dfc48ea76223685634e641d086f7c50b))
* Improve responsive design on AddModal ([#865](https://github.com/cybersholt/VueTorrent/issues/865)) ([a92b583](https://github.com/cybersholt/VueTorrent/commit/a92b583b8b48a8b3dd1c4b2de37c939a34b7d27f))
* include all settings ([#793](https://github.com/cybersholt/VueTorrent/issues/793)) ([3e7f351](https://github.com/cybersholt/VueTorrent/commit/3e7f35107b1b70aef0e0fb13f9d5c322154e87d2))
* Inifite scroll view ([#1049](https://github.com/cybersholt/VueTorrent/issues/1049)) ([c17f1b6](https://github.com/cybersholt/VueTorrent/commit/c17f1b6e8ab5d94a03bc6c43fd2a8bf1526b45fa))
* limit updateMainData to one request at once ([#800](https://github.com/cybersholt/VueTorrent/issues/800)) ([30bedda](https://github.com/cybersholt/VueTorrent/commit/30beddaab425348d020e762bab49b3399f86b9be))
* **localization:** Add missing keys to Tolgee ([#1349](https://github.com/cybersholt/VueTorrent/issues/1349)) ([3adeea4](https://github.com/cybersholt/VueTorrent/commit/3adeea456f7f74307f1e221be506f72ed9d94ea0))
* **localization:** Integrate Tolgee inside CI ([#1276](https://github.com/cybersholt/VueTorrent/issues/1276)) ([86e12da](https://github.com/cybersholt/VueTorrent/commit/86e12da8d0f3ef5e2f7b335277590f8769daf104))
* **login:** Add login with query params ([b9e7372](https://github.com/cybersholt/VueTorrent/commit/b9e7372c8ea4c9ddee390e43bd82b9eba4bc9ef9))
* **logs:** Prevent duplication and add message filter ([#1398](https://github.com/cybersholt/VueTorrent/issues/1398)) ([a1c900c](https://github.com/cybersholt/VueTorrent/commit/a1c900c0b30405869634f8c7947de80875c36a2e))
* **MagnetHandler:** Open add dialog on magnet link ([#1293](https://github.com/cybersholt/VueTorrent/issues/1293)) ([0c546f1](https://github.com/cybersholt/VueTorrent/commit/0c546f1b373b34162ea437c16a7a0574321a8a7f))
* Merge MatchingArticles into RuleForm ([#844](https://github.com/cybersholt/VueTorrent/issues/844)) ([2e3efe7](https://github.com/cybersholt/VueTorrent/commit/2e3efe7b2a08861b426825db91fa85c64f3eef0e))
* **modals:** add autofocus ([#955](https://github.com/cybersholt/VueTorrent/issues/955)) ([5f33d94](https://github.com/cybersholt/VueTorrent/commit/5f33d94d88eff213bbbecf59876fcd9c4f3e90be))
* overview improvements ([#920](https://github.com/cybersholt/VueTorrent/issues/920)) ([e0c5fb5](https://github.com/cybersholt/VueTorrent/commit/e0c5fb5488638da09fd3db4e0ea94bb6bd3a9468))
* **overview:** Add quick actions buttons ([#967](https://github.com/cybersholt/VueTorrent/issues/967)) ([10ada6e](https://github.com/cybersholt/VueTorrent/commit/10ada6ed23800f535e99f4e515a265dda4b71501))
* **overview:** Disable canvas first-time render ([#1029](https://github.com/cybersholt/VueTorrent/issues/1029)) ([d679ad4](https://github.com/cybersholt/VueTorrent/commit/d679ad4c3e3515af00429c2eeb0a7796f0cf35c3))
* **overview:** Disable canvas generation on large torrents ([#947](https://github.com/cybersholt/VueTorrent/issues/947)) ([b56caef](https://github.com/cybersholt/VueTorrent/commit/b56caef1dbc6fe6d5276e4f362be2bd34f40a192))
* **overview:** Fixes spacing for tag chips ([#957](https://github.com/cybersholt/VueTorrent/issues/957)) ([373e825](https://github.com/cybersholt/VueTorrent/commit/373e825cca5d76fa8974026ec25e116c1b11fef0))
* **overview:** Use selected file count instead of total file count to preview filename ([#944](https://github.com/cybersholt/VueTorrent/issues/944)) ([cf5e53c](https://github.com/cybersholt/VueTorrent/commit/cf5e53cbca22df9496fc6fc00f4d8d9745a52ae5))
* Prevent rounding for relative time values ([#1378](https://github.com/cybersholt/VueTorrent/issues/1378)) ([86bba4e](https://github.com/cybersholt/VueTorrent/commit/86bba4e8937e1b8cbe8503efe894682e82c06aef))
* Prevent storing dashboard items label in store ([#748](https://github.com/cybersholt/VueTorrent/issues/748)) ([237de79](https://github.com/cybersholt/VueTorrent/commit/237de79e3392ac12f2f84e21c30a89c036413118))
* Progress component sizing on Desktop ([#720](https://github.com/cybersholt/VueTorrent/issues/720)) ([c991417](https://github.com/cybersholt/VueTorrent/commit/c9914172b55ac1f3e1cdf89a01caec2666f153e3))
* **PWA:** Use Network-only strategy for service worker ([#1468](https://github.com/cybersholt/VueTorrent/issues/1468)) ([f4842c4](https://github.com/cybersholt/VueTorrent/commit/f4842c444484a2e7eda14bd84ed2fba094a695b0))
* Register magnet handler ([#784](https://github.com/cybersholt/VueTorrent/issues/784)) ([82310c8](https://github.com/cybersholt/VueTorrent/commit/82310c843d270e203705fa6ed8d98f355ffdb2e9))
* reset selected torrents when changing filters ([#712](https://github.com/cybersholt/VueTorrent/issues/712)) ([b1b3212](https://github.com/cybersholt/VueTorrent/commit/b1b32127e8fb811d01ec376e42694761a48ba23c))
* Rework Content tab ([#940](https://github.com/cybersholt/VueTorrent/issues/940)) ([516f1d7](https://github.com/cybersholt/VueTorrent/commit/516f1d7913f934a7fcd5f9718cefc9244dde7774))
* Rework desktop cards ([#627](https://github.com/cybersholt/VueTorrent/issues/627)) @Larsluph ([5aeb653](https://github.com/cybersholt/VueTorrent/commit/5aeb65352fc9335112b7747641420579fcd55c47))
* Rework search engine ([#819](https://github.com/cybersholt/VueTorrent/issues/819)) ([834827f](https://github.com/cybersholt/VueTorrent/commit/834827fed40902b318613f1aa509c69819a126b8))
* Rework toast msg for clipboard API ([#677](https://github.com/cybersholt/VueTorrent/issues/677)) ([3e2466a](https://github.com/cybersholt/VueTorrent/commit/3e2466ac8fb383efb735845c74c89b3adf314045))
* **rss-rules:** Add Select All / None buttons ([#849](https://github.com/cybersholt/VueTorrent/issues/849)) ([e9a0ad7](https://github.com/cybersholt/VueTorrent/commit/e9a0ad72ff85a7034c7a8e4e3b2303ffc9541c8b))
* **RssArticles:** Add clearable property to filter ([#992](https://github.com/cybersholt/VueTorrent/issues/992)) ([5b24a02](https://github.com/cybersholt/VueTorrent/commit/5b24a0235b2607d1f92e88e7561200d2ce32e832))
* **rss:** Improve duplicate RSS article handling ([#1191](https://github.com/cybersholt/VueTorrent/issues/1191)) ([ee01382](https://github.com/cybersholt/VueTorrent/commit/ee0138277177dbd9c5054ed81fb8ab11d5b919f0))
* **rss:** Right click mark article as read ([#1210](https://github.com/cybersholt/VueTorrent/issues/1210)) ([ee03b5c](https://github.com/cybersholt/VueTorrent/commit/ee03b5cb58125df8fb073e264cc61bfda85ccd3b))
* scroll to top if tab is changed ([#688](https://github.com/cybersholt/VueTorrent/issues/688)) ([763c3d3](https://github.com/cybersholt/VueTorrent/commit/763c3d31e026a319f4ebf280954d8deb0fbb085c))
* search on enter and customfilter ([#903](https://github.com/cybersholt/VueTorrent/issues/903)) ([754aeb9](https://github.com/cybersholt/VueTorrent/commit/754aeb9959353a8f08ca39f83ebb07048c03118f))
* **search:** Add tabs + reset results on new search ([#958](https://github.com/cybersholt/VueTorrent/issues/958)) ([2de5f85](https://github.com/cybersholt/VueTorrent/commit/2de5f85798cf879c39732edd3c3ecf374110b5ce))
* **search:** autofocus and / shortcut to open search ([#949](https://github.com/cybersholt/VueTorrent/issues/949)) ([b2edc32](https://github.com/cybersholt/VueTorrent/commit/b2edc3274d00c8d0fbf8b2718087c94da3e7247d))
* **search:** Rework search data to save in store ([#991](https://github.com/cybersholt/VueTorrent/issues/991)) ([470ae36](https://github.com/cybersholt/VueTorrent/commit/470ae36cb57cbd501312f993f690e14c94bc7ccc))
* **settings reset:** Clear sessionStorage in addition to localStorage ([4eaaa33](https://github.com/cybersholt/VueTorrent/commit/4eaaa33711f00fcb32515f58fedd6450d83f7cea))
* Show autorun command tooltip when either checkbox is checked ([#789](https://github.com/cybersholt/VueTorrent/issues/789)) ([d1ffa2b](https://github.com/cybersholt/VueTorrent/commit/d1ffa2b143c87d9875c4c05b2c97c37705b68ca5))
* Sort files alphabetically in Content tab ([#714](https://github.com/cybersholt/VueTorrent/issues/714)) ([baf17c7](https://github.com/cybersholt/VueTorrent/commit/baf17c769544c7dba62ae504d4e8f57932c0ebf1))
* Sort folders before files ([#730](https://github.com/cybersholt/VueTorrent/issues/730)) ([521c6e6](https://github.com/cybersholt/VueTorrent/commit/521c6e6c7f0aaacd80c764f056498ad3bf53dc1a))
* Sort tags alphabetically ([#683](https://github.com/cybersholt/VueTorrent/issues/683)) @Larsluph ([3d1415d](https://github.com/cybersholt/VueTorrent/commit/3d1415deab5a90ebca718e086bc8bfc13dca88cc))
* **SpeedGraph:** Init values with null ([#1422](https://github.com/cybersholt/VueTorrent/issues/1422)) ([51d58cf](https://github.com/cybersholt/VueTorrent/commit/51d58cfc4962f3c4fcc71d9e65a09863f695e025))
* **stores:** Rework store structure to prevent circular imports ([#1325](https://github.com/cybersholt/VueTorrent/issues/1325)) ([179af5a](https://github.com/cybersholt/VueTorrent/commit/179af5a1d6886b9543b9170ae697f1011af501b9))
* support command key for mac + unfocus on escape ([acb75a6](https://github.com/cybersholt/VueTorrent/commit/acb75a6a81e9634531f53107876b7ccbeeecf82a))
* **Torrent Card:** Highlight torrent card when TRC menu is showed ([#966](https://github.com/cybersholt/VueTorrent/issues/966)) ([1ba0881](https://github.com/cybersholt/VueTorrent/commit/1ba088163cc88ebd9917086995c911605c57b57a))
* **Torrent Detail:** Add escape exception if modals ([#974](https://github.com/cybersholt/VueTorrent/issues/974)) ([28aeb3e](https://github.com/cybersholt/VueTorrent/commit/28aeb3e8f36b2ccfc1eb09bdbd6b06834a147954))
* **TorrentCard:** Darken selected item background ([#1215](https://github.com/cybersholt/VueTorrent/issues/1215)) ([8214a0e](https://github.com/cybersholt/VueTorrent/commit/8214a0ebd43637bbe3eb7098f5b0ff5a5d0951b8))
* **TorrentCard:** Only process drag on handle ([#1253](https://github.com/cybersholt/VueTorrent/issues/1253)) ([681e59f](https://github.com/cybersholt/VueTorrent/commit/681e59f7c76eb5b984aa968782a81d08fd271cc3))
* **torrentDetail:** top actions fire on current torrent ([#994](https://github.com/cybersholt/VueTorrent/issues/994)) ([b547d9d](https://github.com/cybersholt/VueTorrent/commit/b547d9d2174922002cf7086e269a6dfd55a1d44d))
* **Torrent:** Wrap title ([55c2ef8](https://github.com/cybersholt/VueTorrent/commit/55c2ef811543ebcc84124d3304689f2901064e77))
* **TRC:** display "set priority" visibility when queuing is enabled only ([#976](https://github.com/cybersholt/VueTorrent/issues/976)) ([f2cd9e1](https://github.com/cybersholt/VueTorrent/commit/f2cd9e19a118a2492170a4e99445cff5a956209a))
* tweak torrent title ([0e67cea](https://github.com/cybersholt/VueTorrent/commit/0e67cea318170000ec8fa00ac6918724f3ede999))
* Update translations ([#1373](https://github.com/cybersholt/VueTorrent/issues/1373)) ([a9d9721](https://github.com/cybersholt/VueTorrent/commit/a9d972117999c8c24e24b35f71dbf79825b5b65d))
* use search bar [#891](https://github.com/cybersholt/VueTorrent/issues/891) ([67d76b6](https://github.com/cybersholt/VueTorrent/commit/67d76b63345b1f2b260d7a47af7680eb060c3a72))
